// Near-verbatim port of omarchy's dropbox plugin Model.js (CREDITS.md): the
// status envelope, the file-kind classification behind the row glyphs, and the
// byte / percentage / relative-time formatting the panel reads with.
//
// Their glyphs are already Material Design codepoints, so they survive our
// Symbols Nerd Font fallback unchanged (the FontAwesome range does not).
