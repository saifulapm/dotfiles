...
BarPanel {
    ...
    PanelHero {
        ...
        // The bar mark, at hero size, so the panel and the icon that opened
        // it are recognisably one thing. Nothing in this panel changes on its
        // own any more, so the mark names the hardware — which is what the
        // widget is for now that it answers only "how bright, how big, which
        // screens".
        icon: OpticalGlyph {
            text: "󰍹" // md-monitor
