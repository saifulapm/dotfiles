...
define-command -hidden harpoon-add -docstring "harpoon-add: Add the current file to the list of harpoons" %{
...
define-command -hidden harpoon-nav -params 1 -docstring "harpoon-nav <index>: navigate to the harpoon at <index>" %{
  evaluate-commands %sh{
    index=$1
    eval set -- "$kak_quoted_opt_harpoon_files"
    eval "bufname=\${$index}"
...
define-command -hidden harpoon-show-list -docstring "harpoon-show-list: show all harpoons in the *harpoons* buffer" %{
...
map global user 1 ":harpoon-nav 1<ret>" -docstring "harpoon pick"
map global user 2 ":harpoon-nav 2<ret>" -docstring "harpoon pick"
map global user 3 ":harpoon-nav 3<ret>" -docstring "harpoon pick"
map global user 4 ":harpoon-nav 4<ret>" -docstring "harpoon pick"
map global user 5 ":harpoon-nav 5<ret>" -docstring "harpoon pick"
map global user 6 ":harpoon-nav 6<ret>" -docstring "harpoon pick"
map global user 7 ":harpoon-nav 7<ret>" -docstring "harpoon pick"
map global user 8 ":harpoon-nav 8<ret>" -docstring "harpoon pick"
map global user 9 ":harpoon-nav 9<ret>" -docstring "harpoon pick"
